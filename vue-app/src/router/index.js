...
const routes = [
    { path: basePath ? basePath : '/', name: 'Home', component: Home },
    { path: basePath + '/posts', name: 'PostArchive', component: PostArchive },
    ...
    { path: basePath + '/videos', name: 'VideoArchive', component: VideoArchive },
